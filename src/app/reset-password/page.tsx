        ...
        <div className="w-full max-w-md">
          <div className="bg-[#131313] rounded-2xl shadow-2xl p-6 sm:p-8">
            ...
            <p className="text-gray-200 text-center mb-6 text-sm sm:text-base">
              Мы отправили письмо на адрес <strong>{email}</strong>. Перейдите
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2  focus:border-transparent transition text-sm sm:text-base"
                  disabled={loading}
                />
              </div>
            </div>
