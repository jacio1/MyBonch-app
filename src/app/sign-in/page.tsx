...
export default function SignInPage() {
  ...
  return (
    <div className="h-full flex items-center justify-center p-4 sm:p-8">
      <div className="w-full max-w-md bg-[#131313] rounded-2xl p-8">
        {/* Header */}
        ...
        <div className="bg-[var(--color-card)] rounded-2xl shadow-2xl p-6 sm:p-8 w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="border rounded-lg h-12 w-full pl-10 pr-4"
                  disabled={loading}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="h-12 border rounded-lg w-full pl-10 pr-10"
                  disabled={loading}
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 cursor-pointer bg-indigo-600 rounded-2xl hover:bg-indigo-800 h-12 w-full btn-primary disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
            >
              {loading ? "Вход..." : "Войти"}
            </button>
          </form>
          ...
          {/* Sign Up Link */}
          <p className="mt-12 text-center text-secondary text-sm sm:text-base">
            Нет аккаунта?{" "}
            <Link
              href="/sign-up"
          ...
          <p className="text-center mt-4">
            <Link
              href="/reset-password"
              className="text-secondary hover:text-indigo-600 dark:hover:text-indigo-400 text-sm transition"
            >
              Забыли пароль?
            </Link>
          </p>
